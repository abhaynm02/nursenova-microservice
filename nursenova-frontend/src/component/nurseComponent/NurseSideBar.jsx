...
import { User, Lock, Wallet, LogOut, ChevronLeft, ChevronRight,ReceiptText } from 'lucide-react';
...
const NurseSideBar = () => {
    ...
    const menuItems = [
        { icon: User, text: 'Profile', link: '/nurse/profile' },
        { icon: Lock, text: 'Change Password', link: '/nurse/profile/change-password' },
        {icon:ReceiptText,text:'Details',link:'/nurse/profile/details'},
        { icon: Wallet, text: 'Wallet', link: '/nurse/profile/wallet' },
