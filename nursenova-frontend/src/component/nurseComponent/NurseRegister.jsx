...
import { registerNurse } from '../../api/nurse';
    ...
    const handleSubmit = async (e) => {
      try{
        ...
        if (validate()) {
          ...
          const response = await registerNurse(data1);
          if(response){
            toast.success(response.data.message)
            navigate('/nurse/otp',{ state: { userId: email,firstName:firstname,lastName:lastname}});
          }
